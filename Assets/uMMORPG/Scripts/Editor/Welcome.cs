...
#if UNITY_2019_4
                Debug.Log("uMMORPG | u3d.as/mAn | https://discord.gg/2gNKN78");
#else
                Debug.LogWarning("uMMORPG works best with Unity 2019.4 LTS: https://unity3d.com/unity/qa/lts-releases?version=2019.4");
#endif
            }
        }
    }
